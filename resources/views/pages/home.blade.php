    ...
    <div class="container py-lg-5 py-3">
        ...
        <div class="row d-flex justify-content-center">
            <div class="card col-lg-3 col-md-6 border-0">
                ...
                <img class="card-img-top" src="{{asset('images/a1.jpg')}}" alt="Card image cap">
            </div>
            <div class="card col-lg-3 col-md-6 border-0 mt-md-0 mt-5">
                <img class="card-img-top" src="{{asset('images/a2.jpg')}} " alt="Card image cap ">
            ...
            <div class="card col-lg-3 col-md-6 border-0 mt-lg-0 mt-5 ">
                <img class="card-img-top " src="{{asset('images/a3.jpg')}}" alt="Card image cap ">
                <div class="card-body bg-light text-center">
            ...
            <div class="card col-lg-3 col-md-6 border-0 mt-lg-0 mt-5 text-right">
                ...
                <img class="card-img-top " src="{{asset('images/a4.jpg')}}" alt="Card image cap ">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container py-3">
        ...
        <div class="row team-grids">
            <div class="col-md-3 col-sm-6 w3_agileits-team1">
                <img class="img-fluid" src="{{asset('images/t1.jpg')}}" alt="">
                <h5 class="mt-3">Monica</h5>
                <p>General Manager</p>
                <div class="social-icons mt-2">
                    <ul>
                        <li class="mx-2"><a href="https://www.facebook.com/" target="_blank" class="fab fa-facebook-f icon-border facebook"></a></li>
                        <li class="mx-2"><a href="https://twitter.com/" target="_blank" class="fab fa-twitter  icon-border twitter"></a></li>
                        <li class="mx-2"><a href="https://www.instagram.com/" target="_blank" class="fab fa-instagram icon-border instagram"></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mt-sm-0 mt-5 w3_agileits-team1">
                <img class="img-fluid" src="{{asset('images/t2.jpg')}}" alt="">
                <h5 class="mt-3">Rebeca</h5>
                <p>Director</p>
                <div class="social-icons mt-2">
                    <ul>
                        <li class="mx-2"><a href="https://www.facebook.com/" target="_blank" class="fab fa-facebook-f icon-border facebook"></a></li>
            ...
            <div class="col-md-3 col-sm-6 mt-md-0 mt-5 w3_agileits-team1">
                <img class="img-fluid" src="{{asset('images/t3.jpg')}}" alt="">
                <h5 class="mt-3"> SUSAN</h5>
                <p>Sales manager</p>
                <div class="social-icons mt-2">
                    <ul>
                        <li class="mx-2"><a href="https://www.facebook.com/" target="_blank" class="fab fa-facebook-f icon-border facebook"></a></li>
            ...
            <div class="col-md-3 col-sm-6 mt-md-0 mt-5 w3_agileits-team1">
                <img class="img-fluid" src="{{asset('images/t4.jpg')}}" alt="">
                <h5 class="mt-3">MARGARET</h5>
                <p>Sales clerk</p>
                <div class="social-icons mt-2">
                    <ul>
                        <li class="mx-2"><a href="https://www.facebook.com/" target="_blank" class="fab fa-facebook-f icon-border facebook"></a></li>
